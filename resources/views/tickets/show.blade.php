<x-guest-layout>
    <div
        class="container w-full p-4 px-6 py-4 mx-auto mt-6 overflow-hidden bg-white shadow-md sm:max-w-2xl dark:bg-gray-800 sm:rounded-lg">
        @if (session('message'))
        ...
        <div class="rounded ">
            ...
            <div class="mb-4">
                ...
                <p class="block ml-2 text-sm font-medium text-gray-700 dark:text-gray-200">{{ $ticket->customer_name }}
                </p>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400">Problem Description:</label>
                <p class="block ml-2 text-sm font-medium text-gray-700 dark:text-gray-200">
                    {{ $ticket->problem_description }}</p>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400">Email:</label>
                <p class="block ml-2 text-sm font-medium text-gray-700 dark:text-gray-200">{{ $ticket->email }}</p>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400">Phone:</label>
                <p class="block ml-2 text-sm font-medium text-gray-700 dark:text-gray-200">{{ $ticket->phone }}</p>
            </div>
            <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <ul class="overflow-y-scroll">
                        @foreach ($ticket->replies as $reply)
                            <li class="p-3 mb-2 bg-gray-100 rounded">
                                <p>{{ $reply->message }}</p>
                                <p class="flex justify-end text-sm text-gray-500">Replied on
